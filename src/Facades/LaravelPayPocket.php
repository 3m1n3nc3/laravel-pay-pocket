 ...
 *
 * @method static void pay($user, int|float $orderValue, array $allowedWallets = [], ?string $notes = null)
 * @method static bool deposit($user, string $type, int|float $amount, ?string $notes = null)
